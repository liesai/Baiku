...
TEMPLATES: tuple[WorkoutTemplate, ...] = (
    ...
    WorkoutTemplate(
        key="home_trainer_endurance_25",
        name="Home trainer endurance facile",
        category="Home Trainer",
        steps=(
            WorkoutTemplateStep(300, 0.52, "Warmup souple", 80, 90),
            WorkoutTemplateStep(1500, 0.62, "Endurance zone 2", 82, 92),
            WorkoutTemplateStep(300, 0.50, "Cool-down", 78, 88),
        ),
    ),
    WorkoutTemplate(
        key="home_trainer_souple_15",
        name="Home trainer souple",
        category="Home Trainer",
        steps=(
            WorkoutTemplateStep(180, 0.50, "Mise en route", 78, 88),
            WorkoutTemplateStep(720, 0.58, "Zone 2 facile", 82, 90),
            WorkoutTemplateStep(180, 0.48, "Retour au calme", 75, 85),
        ),
    ),
    WorkoutTemplate(
        key="home_trainer_8x40_80",
        name="Home trainer 8x(40/80)",
        category="Home Trainer",
        steps=(
            WorkoutTemplateStep(600, 0.55, "Warmup", 85, 95),
            WorkoutTemplateStep(40, 1.05, "Fort #1", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #1", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #2", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #2", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #3", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #3", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #4", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #4", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #5", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #5", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #6", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #6", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #7", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #7", 80, 90),
            WorkoutTemplateStep(40, 1.05, "Fort #8", 95, 108),
            WorkoutTemplateStep(80, 0.50, "Facile #8", 80, 90),
            WorkoutTemplateStep(420, 0.50, "Cool-down", 78, 88),
        ),
    ),
    WorkoutTemplate(
        key="home_trainer_finisher_progressif_16",
        name="Finisher home trainer progressif",
        category="Home Trainer",
        steps=(
            WorkoutTemplateStep(240, 0.55, "Mise en route", 82, 92),
            WorkoutTemplateStep(240, 0.65, "Progressif 1", 84, 94),
            WorkoutTemplateStep(240, 0.72, "Progressif 2", 86, 96),
            WorkoutTemplateStep(240, 0.80, "Progressif 3", 88, 98),
        ),
    ),
    WorkoutTemplate(
        key="sweetspot_45",
